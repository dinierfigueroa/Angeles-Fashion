...
const navLinks = [
  ...
  { name: 'Gastos Tarjeta', route: 'admin-expenses', permission: 'canReconcileExpenses', icon: 'M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3z' },
];
